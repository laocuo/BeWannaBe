...
public class ColorfulPagerIndicator extends LinearLayout
{
    ...
    public ColorfulPagerIndicator(Context context)
    {
        this(context, null);
        setOrientation(HORIZONTAL);
    }

    public ColorfulPagerIndicator(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        mAttrs = attrs;
        setOrientation(HORIZONTAL);
        ...
        mTabVisibleCount = a.getInt(R.styleable.ViewPagerIndicator_item_visiable,
                COUNT_DEFAULT_TAB);
...
//        mPaint.setColor(Color.parseColor("#ffffffff"));
    ...
    public void setTabItemTitles(List<String> datas, List<Integer> iconList)
    {
        ...
        if (datas != null && datas.size() > 0)
        {
            ...
            for (int i=0;i<datas.size();i++) {
                // 添加view
                addView(generateView(mTabTitles.get(i), iconList.get(i)));
            }
            ChangeColorIconWithTextView v = (ChangeColorIconWithTextView)getChildAt(0);
            v.setIconAlpha(1.0f);
            // 设置item的click事件
            setItemClickEvent();
        }
    ...
    private View generateView(String s, int icon) {
        ChangeColorIconWithTextView v = new ChangeColorIconWithTextView(getContext());
        v.setBitmapAndText(icon, s);
    ...
    public void setViewPager(ViewPager mViewPager, int pos)
    {
        ...
        mViewPager.setOnPageChangeListener(new OnPageChangeListener()
        {
                                       ...
                                       int positionOffsetPixels)
            {
                ...
                if (positionOffset > 0)
                {
                    ChangeColorIconWithTextView left = (ChangeColorIconWithTextView)getChildAt(position);
                    ChangeColorIconWithTextView right = (ChangeColorIconWithTextView)getChildAt(position+1);
